...
im_dir = '/home/hjalmar/GDrive/data/PERPL/StatLearn1/Stimuli/Fractals/512x512/jpg/'
...
e = compare_image_pair(images[0], images[5], verbose=False)
...
fig.savefig('bolar_image_pair.png')
fig.savefig('bolar_image_pair.svg')
...
fig.savefig('bolar_image_differences.png')
fig.savefig('bolar_image_differences.svg')
...
fig.savefig('bolar_image_differences_dendrogram.png')
fig.savefig('bolar_image_differences_dendrogram.svg')    